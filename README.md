About ocgis-feedstock
=====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ocgis-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5384&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ocgis-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ocgis` can be installed with `conda`:
...
It is possible to list all of the versions of `ocgis` available on your platform with `conda`:
...
```
mamba search ocgis --channel conda-forge
```
...
mamba repoquery search ocgis --channel conda-forge

# List packages depending on `ocgis`:
mamba repoquery whoneeds ocgis --channel conda-forge

# List dependencies of `ocgis`:
mamba repoquery depends ocgis --channel conda-forge
```
